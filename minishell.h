...
/*   Updated: 2025/09/27 14:02:10 by yalkhidi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						token_word(const char *input, size_t *i,
							t_token **tokens);
...
int						handle_word(const char *input, size_t *i,
							t_word **words);
...
// Expander
char					*handle_ambiguous_redirect(char *arg, int start,
							int end);
...
int						builtin_child(t_ast *ast, t_shell *shell, int in,
							int out);
void					builtin_parent(t_ast *ast, t_shell *shell);
void					clean_and_exit(char **argv, char **env_arr,
